        ...
        >
            <section id="cmalt-guidance">
                ...
                <p>
                    ...
                    specialist areas. This reflects the fact that, although
                    there are common areas of work for learning technologists,
                    practice is extremely diverse and everyone specialises in
                    something different.
                </p>

                <p>
                    Your specialist topic should reflect an area where you have
                    particular expertise. This may be unique to you or common
                    across your team, but goes beyond what would be expected of
                    any learning technologist. Below are examples of specialist
                    areas chosen by CMALT holders. You are free to choose from
                    it, or to select a different area that reflects your
                    expertise. It is recognised that practice is constantly
                    evolving and that CMALT candidates come from very diverse
                    contexts; this list of examples is neither comprehensive nor
                    prescriptive.
                </p>
                ...
                <ul>
                    ...
                    <li>
                        knowledge and application of emerging standards for
                        Learning Technology;
                    </li>
