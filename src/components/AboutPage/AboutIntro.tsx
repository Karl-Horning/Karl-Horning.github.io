...
export default function AboutIntro() {
    return (
        ...
        >
            ...
            <p className="mb-4">
                Hi, I&apos;m Karl, a developer and learning technologist from
                the UK.
            </p>
            <p className="mb-4">
                I love solving real-world problems through code, especially when
                it involves working with APIs, data, or accessible web
            ...
            <p className="mb-4">
                ...
                decisions around learning technology. I enjoy switching between
                writing code and designing practical solutions that support
                people.
            </p>
            <p className="mb-4">
                Right now, I&apos;m working on a few side projects, including an
                image optimiser built with Electron and Vite, and a
                Markdown-based writing tracker inspired by the &quot;200 words a
                day&quot; method. I&apos;m always learning and always building.
            </p>
            <p className="mb-6">
